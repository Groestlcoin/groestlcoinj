...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals(Coin.valueOf(1024, 0), wallet.getBalance());
        ...
        assertEquals(Coin.valueOf(2048, 0), wallet.getBalance());
    }
    ...
    public void testForking3() throws Exception {
        ...
        assertEquals(valueOf(511, 0), wallet.getBalance());
        Block b2 = b1.createNextBlock(someOtherGuy);
        ...
        assertEquals(valueOf(511, 0), wallet.getBalance(Wallet.BalanceType.ESTIMATED));
        assertEquals(ConfidenceType.PENDING, spend.getConfidence().getConfidenceType());
    }
    ...
    public void testForking4() throws Exception {
        ...
        assertEquals(MAX_REWARD_COINS, wallet.getBalance());
        Address dest = new ECKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.TESTNET);
        Transaction spend = wallet.createSend(dest, MAX_REWARD_COINS);
    ...
    public void testDoubleSpendOnFork() throws Exception {
        ...
        Transaction t1 = wallet.createSend(someOtherGuy, valueOf(1, 0));
        Address yetAnotherGuy = new ECKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.TESTNET);
        Transaction t2 = wallet.createSend(yetAnotherGuy, valueOf(2, 0));
        wallet.commitTx(t1);
        ...
        assertEquals(valueOf(510, 0), wallet.getBalance());
    }
    ...
    public void testDoubleSpendOnForkPending() throws Exception {
        ...
        Transaction t1 = Objects.requireNonNull(wallet.createSend(someOtherGuy, valueOf(1, 0)));
        Address yetAnotherGuy = new ECKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.TESTNET);
        Transaction t2 = Objects.requireNonNull(wallet.createSend(yetAnotherGuy, valueOf(2, 0)));
        wallet.commitTx(t1);
        // t1 is still pending ...
        Block b2 = b1.createNextBlock(new ECKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.TESTNET));
        chain.add(b2);
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals(Coin.valueOf(2560, 0), wallet.getBalance());
    ...
    public void coinbaseDeath() throws Exception {
        ...
        // ... and spend.
        Transaction fodder = wallet.createSend(new ECKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.TESTNET), FIVE_COINS);
