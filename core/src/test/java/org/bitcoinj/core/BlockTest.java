...
public class BlockTest {
    ...
    public void setUp() throws Exception {
        ...
        block1084745Bytes = ByteStreams.toByteArray(BlockTest.class.getResourceAsStream("block_testnet700000.dat"));
        block1084745 = TESTNET.getDefaultSerializer().makeBlock(ByteBuffer.wrap(block700000Bytes));
        assertEquals("000000001f1afc05cb4403f5776c863afd4c71da4e4ea184e43e41b25d071b15", block700000.getHashAsString());
    }
    ...
    public void testDate() {
        assertEquals("2016-02-13T22:59:39Z", TimeUtils.dateTimeFormat(block1084745.time()));
    ...
    public void testReceiveCoinbaseTransaction() throws Exception {
        ...
        Block.verify(MAINNET, block159543, 159543, EnumSet.noneOf(Block.VerifyFlag.class));
