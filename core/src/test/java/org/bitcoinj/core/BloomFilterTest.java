...
public class BloomFilterTest {
    ...
    public void walletTest() {
        ...
        DumpedPrivateKey privKey = DumpedPrivateKey.fromBase58(BitcoinNetwork.MAINNET, "5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuT2mcX7");

        Address addr = privKey.getKey().toAddress(ScriptType.P2PKH, BitcoinNetwork.MAINNET);
        assertEquals("FbgfTB93Xt8uxRRUAxTQsx9mrL5jzdmWCw", addr.toString());
        ...
        // Value generated by Bitcoin Core
        assertEquals("082a81edc8a51f7a83080000000000000002", ByteUtils.formatHex(filter.serialize()));
    }
}
