...
public class ECKeyTest {
    ...
    public void verifyMessageSignedWithCompressedP2PKHaddress() throws Exception {
        ...
        Address expectedAddress = LegacyAddress.fromBase58("FYtbkd327Z9X8KeG23M7qLQtT76VrVnAfa", MAINNET);
    ...
    @Test @Ignore // TODO: find GRS example
    ...
    public void verifyMessageSignedWithNativeSegwitP2WPKHAddress() throws Exception {
        ...
        Address expectedAddress = SegwitAddress.fromBech32("grs1qvcl0z7f25sf2u8up5wplk7arwclghh7de8fy6l", MAINNET);
        ECKey key = ECKey.signedMessageToKey(message, sigBase64);
