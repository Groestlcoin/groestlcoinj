...
public class DefaultRiskAnalysisTest {
    ...
    public void canonicalSignatureLowS() throws Exception {
        ...
        assertEquals("c7565c7158453f542b018d07c0d9212bd5bdbc9906020527b1d87cac3996fae6", tx1.getTxId().toString());
        ...
        assertEquals("f29a8df2ea50eca8be173d3c7e341fd8793b8207575e7ebc017e54b072ddce16", tx2.getTxId().toString());
