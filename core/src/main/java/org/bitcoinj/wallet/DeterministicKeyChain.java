...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public static final HDPath BIP44_ACCOUNT_ZERO_PATH = HDPath.M(new ChildNumber(44, true))
                        .extend(new ChildNumber(17, true), ChildNumber.ZERO_HARDENED);
    public static final HDPath BIP44_TESTNET_ACCOUNT_ZERO_PATH = HDPath.M(new ChildNumber(44, true))
    ...
    public static final HDPath BIP84_ACCOUNT_ZERO_PATH = HDPath.M(new ChildNumber(84, true))
            .extend(new ChildNumber(17, true), ChildNumber.ZERO_HARDENED);
    public static final HDPath BIP84_TESTNET_ACCOUNT_ZERO_PATH = HDPath.M(new ChildNumber(84, true))
            .extend(ChildNumber.ONE_HARDENED, ChildNumber.ZERO_HARDENED);
