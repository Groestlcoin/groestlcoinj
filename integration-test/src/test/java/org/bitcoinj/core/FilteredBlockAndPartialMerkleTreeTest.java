...
public class FilteredBlockAndPartialMerkleTreeTest extends TestWithPeerGroup {
    ...
    public void setUp() throws Exception {
        ...
        store.put(new StoredBlock(SERIALIZER.makeBlock(ByteBuffer.wrap(ByteUtils.parseHex(""))),
                BigInteger.ONE, 100_000));
        store.setChainHead(store.get(Sha256Hash.wrap("0000006d6d7fb859e9745a1cd173e4b03793a8ff8917c334d03de28a8557102e")));
    ...
    public void deserializeFilteredBlock() {
        ...
        assertEquals(Sha256Hash.wrap("cf14f88b6c5dfa8fdf3cebb97dae7231a3e10124cada98dd3fa2e2593136636a"), block.getBlockHeader().getHash());
    ...
    public void createFilteredBlock() throws Exception {
        ...
        Block block = FakeTxBuilder.makeSolvedTestBlock(TESTNET.getGenesisBlock(), LegacyAddress.fromBase58("msg2t2V2sWNd85LccoddtWysBTR8juqQkq", BitcoinNetwork.TESTNET), tx1, tx2);
    ...
    @Test  @Ignore // this needs a lot of work
